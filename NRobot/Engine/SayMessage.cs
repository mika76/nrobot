...
{
	/// <summary>
	/// A message that has been "said" during the tick.
	/// </summary>
	[Serializable]
	internal class SayMessage
	{
		internal SayMessage(Robot robot, string message)
		{
			this.robot = robot;
		...
		private Robot robot;
		internal Robot Robot {get {return robot;}}
